...
│                         diffusion_models and configuration for tools like black
│
...
│
└── diffusion_models   <- Source code for use in this project.
    │
    ├── __init__.py             <- Makes diffusion_models a Python module
    │
